...
from .views import ResponseVacancyView, ResponseCandidateListView, ResponseCompanyListView, ResponseVacancyListView, ResponseToCandidateView
...
urlpatterns = [
    ...
    # responses to candidate's responses
    path('answer_to=<int:pk_response>', ResponseToCandidateView.as_view()),
    # path(''),
]
